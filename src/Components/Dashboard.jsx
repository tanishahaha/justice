  ...
  return (
    <div className="p-6 mt-16">
      <div className="grid grid-cols-3 gap-6">
        <div className={`col-span-2 bg-teal-400 p-6 rounded-lg shadow-lg ${styles.boxBg}`}>
          <div className="grid grid-cols-3 gap-6">
      ...
      <div className="grid grid-cols-3 gap-6 mt-6">
        <div className={`col-span-2 bg-teal-400  rounded-lg shadow-lg ${styles.boxBg}`} >
        ...
        <div className={`col-span-1 bg-teal-400 p-4 rounded-lg shadow-lg ${styles.boxBg}`}>
          <div className="flex justify-between items-center mb-4">
